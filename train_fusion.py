...
if __name__ == '__main__':
    ...
    parser.add_argument('--ir_low_contrast_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/IR_Low_contrast")
    parser.add_argument('--ir_noise_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/IR_Random_noise")
    parser.add_argument('--ir_stripe_noise_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/IR_Stripe_noise")
    parser.add_argument('--vis_blur_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/vis_Blur")
    parser.add_argument('--vis_haze_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/vis_Haze")
    parser.add_argument('--vis_rain_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/vis_Rain")
    parser.add_argument('--vis_random_noise_path', type=str, default="./SensorFusion/dataset/EMS_dataset/full/vis_Random_noise")
